...
import (
	...
	peerpkg "github.com/PutinCoinPUT/ppcd/peer"
...
// processed.
func (sm *SyncManager) QueueTx(tx *ppcutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *ppcutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *ppcutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
