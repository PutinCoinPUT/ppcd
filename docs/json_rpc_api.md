...
[rpcclient](https://btcdemoppc/ppcd/tree/master/rpcclient) package.
...
[rpcclient](https://btcdemoppc/ppcd/tree/master/rpcclient) package to connect with
...
func main() {
	...
	// have one.
	btcdHomeDir := ppcutil.AppDataDir("btcd", false)
