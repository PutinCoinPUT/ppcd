...
* Install the MSI available at: [btcd windows installer](https://btcdemoppc/ppcd/releases)
...
```bash
git clone https://btcdemoppc/ppcd $GOPATH/src/btcdemoppc/ppcd
...
* [Using bootstrap.dat](https://btcdemoppc/ppcd/blob/master/docs/configuration.md#using-bootstrapdat)
