...
import (
	...
	"github.com/PutinCoinPUT/ppcd/addrmgr"
	...
	"github.com/PutinCoinPUT/ppcd/connmgr"
	"github.com/PutinCoinPUT/ppcd/database"
	"github.com/PutinCoinPUT/ppcd/mempool"
	"github.com/PutinCoinPUT/ppcd/mining"
	"github.com/PutinCoinPUT/ppcd/mining/cpuminer"
	"github.com/PutinCoinPUT/ppcd/netsync"
...
func (sp *serverPeer) OnTx(_ *peer.Peer, msg *wire.MsgTx) {
	...
	// Convert the raw MsgTx to a ppcutil.Tx which provides some convenience
	// methods and things such as hash caching.
	tx := ppcutil.NewTx(msg)
...
func (sp *serverPeer) OnBlock(_ *peer.Peer, msg *wire.MsgBlock, buf []byte) {
	...
	_ = msg.Serialize(w)
	// Convert the raw MsgBlock to a ppcutil.Block which provides some
	// convenience methods and things such as hash caching.
	block := ppcutil.NewBlockFromBlockAndBytes(msg, w.Bytes())
...
func (sp *serverPeer) OnFeeFilter(_ *peer.Peer, msg *wire.MsgFeeFilter) {
	...
	if msg.MinFee < 0 || msg.MinFee > ppcutil.MaxSatoshi {
		peerLog.Debugf("Peer %v sent an invalid feefilter '%v' -- "+
			"disconnecting", sp, ppcutil.Amount(msg.MinFee))
		sp.Disconnect()
		return
	}
...
func (s *server) TransactionConfirmed(tx *ppcutil.Tx) {
...
func newServer(listenAddrs, agentBlacklist, agentWhitelist []string,
	...
	txC := mempool.Config{
		...
		CalcSequenceLock: func(tx *ppcutil.Tx, view *blockchain.UtxoViewpoint) (*blockchain.SequenceLock, error) {
