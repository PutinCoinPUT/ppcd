...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/btcdemoppc/ppcd/chaincfg)
...
func main() {
	...
	addr, err := ppcutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println(addr)
...
```bash
$ go get -u btcdemoppc/ppcd/chaincfg
```
