...
import (
	...
	"github.com/PutinCoinPUT/ppcd/btcjson"
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []ppcutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []ppcutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee ppcutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee ppcutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address ppcutil.Address, amount ppcutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address ppcutil.Address, amount ppcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address ppcutil.Address,
	amount ppcutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address ppcutil.Address, amount ppcutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress ppcutil.Address, amount ppcutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress ppcutil.Address, amount ppcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress ppcutil.Address, amount ppcutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress ppcutil.Address, amount ppcutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress ppcutil.Address, amount ppcutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress ppcutil.Address,
	amount ppcutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[ppcutil.Address]ppcutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[ppcutil.Address]ppcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[ppcutil.Address]ppcutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[ppcutil.Address]ppcutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (ppcutil.Address, error) {
	...
	return ppcutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []ppcutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []ppcutil.Address, account string) (ppcutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []ppcutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []ppcutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (ppcutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
// chain params.
func (c *Client) GetNewAddress(account string) (ppcutil.Address, error) {
...
// chain params.
func (c *Client) GetNewAddressType(account, addrType string) (ppcutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (ppcutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (ppcutil.Address, error) {
...
// transactions and NOT for normal use.
func (c *Client) GetRawChangeAddressType(account, addrType string) (ppcutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (ppcutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (ppcutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (ppcutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (ppcutil.Address, error) {
...
func (c *Client) GetAccountAsync(address ppcutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address ppcutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address ppcutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address ppcutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]ppcutil.Address, error) {
	res, err := ReceiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]ppcutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = ppcutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]ppcutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount ppcutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount ppcutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount ppcutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount ppcutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount ppcutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount ppcutil.Amount,
...
func (c *Client) ValidateAddressAsync(address ppcutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address ppcutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]ppcutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]ppcutil.Amount)
	for k, v := range accounts {
		amount, err := ppcutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]ppcutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]ppcutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (ppcutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := ppcutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the Response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (ppcutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (ppcutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (ppcutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (ppcutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (ppcutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (ppcutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (ppcutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (ppcutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (ppcutil.Amount, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address ppcutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address ppcutil.Address) (ppcutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address ppcutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address ppcutil.Address, minConfirms int) (ppcutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address ppcutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address ppcutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address ppcutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address ppcutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*ppcutil.WIF, error) {
	res, err := ReceiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return ppcutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address ppcutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address ppcutil.Address) (*ppcutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *ppcutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *ppcutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *ppcutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *ppcutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *ppcutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *ppcutil.WIF, label string, rescan bool) error {
