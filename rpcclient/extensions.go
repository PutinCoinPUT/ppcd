...
//
// NOTE: This is a btcd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []ppcutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a btcwallet extension.
func (c *Client) ListAddressTransactions(addresses []ppcutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
