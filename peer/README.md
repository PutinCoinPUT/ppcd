...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/btcdemoppc/ppcd/peer)
...
```bash
$ go get -u btcdemoppc/ppcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/btcdemoppc/ppcd/peer#example-package--NewOutboundPeer)  
