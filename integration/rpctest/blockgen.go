...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr ppcutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*ppcutil.Tx, error) {
...
func CreateBlock(prevBlock *ppcutil.Block, inclusionTxs []*ppcutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr ppcutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*ppcutil.Block, error) {
	...
	blockTxns := []*ppcutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := ppcutil.NewBlock(&block)
