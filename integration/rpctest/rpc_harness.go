...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*ppcutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []ppcutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (ppcutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() ppcutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*ppcutil.Tx, blockVersion int32,
	blockTime time.Time) (*ppcutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*ppcutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*ppcutil.Block, error) {
	...
	prevBlock := ppcutil.NewBlock(mBlock)
