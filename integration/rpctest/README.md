...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/btcdemoppc/ppcd/integration/rpctest)
...
```bash
$ go get -u btcdemoppc/ppcd/integration/rpctest
```
