...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*ppcutil.Tx, witness bool) []*chainhash.Hash {
...
// also presents an additional case wherein the wtxid of the coinbase transaction
// is the zeroHash.
func CalcMerkleRoot(transactions []*ppcutil.Tx, witness bool) chainhash.Hash {
...
func ExtractWitnessCommitment(tx *ppcutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *ppcutil.Block) error {
