...
func (view *UtxoViewpoint) AddTxOut(tx *ppcutil.Tx, txOutIdx uint32, blockHeight int32, timestamp time.Time) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *ppcutil.Tx, blockHeight int32, timestamp time.Time) {
...
func (view *UtxoViewpoint) connectTransaction(tx *ppcutil.Tx, blockHeight int32, timestamp time.Time, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *ppcutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *ppcutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *ppcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *ppcutil.Tx) (*UtxoViewpoint, error) {
