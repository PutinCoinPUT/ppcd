...
import (
	...
	_ "github.com/PutinCoinPUT/ppcd/database/ffldb"
...
// ppcutil.Block.  This is largely borrowed from the test code in btcdb.
func loadBlocks(filename string) (blocks []*ppcutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = ppcutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
