...
import (
	"github.com/PutinCoinPUT/ppcd/btcec/ecdsa"
	"github.com/PutinCoinPUT/ppcd/database"
	"github.com/PutinCoinPUT/ppcd/txscript"
	"fmt"

	// "github.com/PutinCoinPUT/ppcd/btcec/v2"
...
func getProofOfStakeFromBlock(block *ppcutil.Block) Stake {
...
func (b *BlockChain) calcMintAndMoneySupply(block *ppcutil.Block, prevHash *chainhash.Hash) error {
...
func getCoinAgeTx(tx *ppcutil.Tx, nTimeTx int64, utxoView *UtxoViewpoint, chainParams *chaincfg.Params, isTrueCoinAge bool) (int64, error) {
...
func (b *BlockChain) getCoinAgeBlock(node *blockNode, block *ppcutil.Block) (uint64, error) {
...
func PPCGetProofOfStakeReward(nCoinAge int64) ppcutil.Amount {
	...
	return ppcutil.Amount(nSubsidy)
}
...
func IsCoinStake(tx *ppcutil.Tx) bool {
...
// Export required, used in ppcwallet createCoinStake method
func getMinFee(tx *ppcutil.Tx, chainParams *chaincfg.Params) int64 {
	baseFee := MinTxFee
...
func CheckBlockSignature(msgBlock *wire.MsgBlock,
	...
	a, ok := addresses[0].(*ppcutil.AddressPubKey)
	if !ok {
		return false
	}
...
func ppcCheckTransactionSanity(chainParams *chaincfg.Params, tx *ppcutil.Tx) error { // todo ppc add more rules where needed
	msgTx := tx.MsgTx()
...
func ppcCheckTransactionInputs(tx *ppcutil.Tx, nTimeTx int64, utxoView *UtxoViewpoint, moneySupply int64,
...
func ppcCheckBlockSanity(chainParams *chaincfg.Params, block *ppcutil.Block) error {
...
func (b *BlockChain) ppcProcessOrphan(block *ppcutil.Block) error {
...
func (b *BlockChain) ppcOrphanBlockRemoved(block *ppcutil.Block) {
	// https://github.com/ppcoin/ppcoin/blob/v0.4.0ppc/src/main.cpp#L2078
	delete(stakeSeenOrphan, getProofOfStakeFromBlock(block))
}

func (b *BlockChain) ppcProcessBlock(block *ppcutil.Block, phase processPhase) error {
	switch phase {
	case phasePreSanity:
