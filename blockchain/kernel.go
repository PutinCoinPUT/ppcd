...
// blocks.
func (b *BlockChain) computeNextStakeModifier(pindexCurrent *ppcutil.Block) (
...
func (b *BlockChain) addToBlockIndex(block *ppcutil.Block) (err error) {
...
func (b *BlockChain) checkStakeKernelHash(
	prevNode *blockNode, nBits uint32, blockFrom *ppcutil.Block, nTxPrevOffset uint32,
	txPrev *ppcutil.Tx, prevout *wire.OutPoint, nTimeTx int64,
...
func (b *BlockChain) checkTxProofOfStake(prevNode *blockNode, tx *ppcutil.Tx, inputs *UtxoViewpoint, timeSource MedianTimeSource, nBits uint32, blockTime time.Time) (
...
func (b *BlockChain) checkBlockProofOfStake(prevNode *blockNode, block *ppcutil.Block, timeSource MedianTimeSource) error {
...
func (b *BlockChain) getStakeModifierChecksum(
	pindex *ppcutil.Block) (checkSum uint32, err error) {
...
func (b *BlockChain) verifySignature(utxoView *UtxoViewpoint, txIn *wire.TxIn, tx *ppcutil.Tx,
