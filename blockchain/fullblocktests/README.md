...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/btcdemoppc/ppcd/blockchain/fullblocktests)
...
```bash
$ go get -u btcdemoppc/ppcd/blockchain/fullblocktests
```
