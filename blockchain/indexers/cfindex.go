...
func storeFilter(dbTx database.Tx, block *ppcutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *ppcutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *ppcutil.Block,
